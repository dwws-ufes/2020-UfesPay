...
public class UserServiceBean implements UserService {
	...
	@Transactional
	private void addLikes(Transaction transac, List<User> users) {
		for(User aux  : users){
			transac.getLikes().add(aux);
		}
