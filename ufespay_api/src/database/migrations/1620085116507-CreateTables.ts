...
export class CreateTables1620085116507 implements MigrationInterface {
    name = 'CreateTables1620085116507'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "transaction" (
                ...
                "likes" character varying array NOT NULL DEFAULT '{}',
                "created_at" TIMESTAMP NOT NULL DEFAULT now(),
                "updated_at" TIMESTAMP NOT NULL DEFAULT now(),
        ...
        await queryRunner.query(`
            ALTER TABLE "comment"
            ADD CONSTRAINT "FK_d058388f4fc2cb6c1109fa292ae" FOREIGN KEY ("transactionId") REFERENCES "transaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ALTER TABLE "comment" DROP CONSTRAINT "FK_d058388f4fc2cb6c1109fa292ae"
        `);
        await queryRunner.query(`
